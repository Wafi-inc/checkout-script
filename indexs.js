          ...
          >
            ...
            <div style="padding-left: 15px; padding-top: 10px;">
                ...
                <div>
                  ...
                  <span style="font-weight: 100; font-size: 14px; color: #5d5d5d;"> 
                    There are no interest payments or late fees to worry about ever.
                  </span>
                </div>
              </div>
...
// Wafi checkout Buttons
// *******************************
const wafiPaySelectionStyles = { black: "white", white: "black" };

class wafiPaySelection extends HTMLElement {
  connectedCallback() {
    let styleType = this.attributes?.styleType?.value;
    console.log("you have selected type: ", styleType);

    if (!Object.values(wafiPaySelectionStyles).includes(styleType)) {
    ...
    <button style="
    color: ${wafiPaySelectionStyles[styleType]};
        ...
        font-weight: bold;
        border-radius: 5px;
        border: ${styleType === "white" ? "5px solid black" : "0px"};
        margin: 8px;
        cursor: pointer;">
        ...
        Pay with your bank. <span style="color: #2C39D1; cursor:pointer; margin-left:3px;"> Get 0.75% cash back</span>
        </div>
...
customElements.define("wafi-pay-select", wafiPaySelection);
